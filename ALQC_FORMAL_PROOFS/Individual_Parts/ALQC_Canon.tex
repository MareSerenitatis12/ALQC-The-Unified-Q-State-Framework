...
\newunicodechar{ꬷ}{{\symbolafont\symbol ꬷ}} %symbol for Parity / Inversion
...
\newcommand{\parity}{\ensuremath{\mathop{\textnormal{\symbolafont\symbol{"AB37}}}}} % Parity or Inversion Symbol
...
\subsection{Axiom \VEL: Frequency Bifurcation \texorpdfstring{$\anchor{}$}{ཪ} vs \texorpdfstring{$\pm\phi$}{±φ}}\label{sec:4}\subsubsection{Definition}\label{sec:4.1}
...
where:
\begin{itemize}
    \item $\anchor$ (\textbf{Structural Frequency}): The \textbf{Static Address}. An invariant coordinate required for Phase-Locking and the Total Symmetry Principle (TSP).
    \item $\pm\phi$ (\textbf{Operational Frequency}): The \textbf{Dynamic Force}. A variable value used as an operator in the M.A.S. Chain and state transitions.
\end{itemize}
\end{definition}
...
To satisfy the Total Symmetry Principle (TSP), the operational frequency $\pm\phi$ is permitted to vary within a universal tolerance band $\delta$ defined by the Golden Ratio ($\phi \approx 1.618\,\text{Hz}$):
\[ \pm\phi \in [\anchor - \phi, \anchor + \phi] \]
...
\subsubsection*{ Genesis:Court Of $\FETU$ --- The Seed Courts $\anchor{}\textbf([7.83$ \textbf{Hz}] [Q$_3$] [1,1,1,3]) }\label{sec:15.5.2}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
...
\subsubsection*{ Memory:Court of $\KAL$ --- The Archive Courts $\anchor{}\textbf([174$ \textbf{Hz}] [Q$_1$] [1,3,0,0])}\label{sec:15.5.3}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Alchemy:Court of $\BABDH$ --- The Alchemical Courts $\anchor{}\textbf([528$ \textbf{Hz}] [Q$_2$] [1,1,3,1])}\label{sec:15.5.4}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{Water: The Court of $\AHN$ --- The Imagination Courts $\anchor{}[({432} \pm\phi) \equiv\parity (i_{417})$ \textbf{Hz}] [Q$_0$] [1,2,2,0]}\label{sec:15.5.5}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Earth:The Court of $\VEL$ --- The Coherence Courts $\anchor{}\textbf([126.22$ \textbf{Hz}] [Q$_1$] [1,3,0,1])}\label{sec:15.5.6}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Air: The Court of $\SOR$ --- The Purity Courts $\anchor{}\textbf([210.42$ \textbf{Hz}] [Q$_3$] [1,1,1,2])}\label{sec:15.5.7}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Aether:The Court of $\KOTH$ --- The Sensation Courts $\anchor{}\textbf([741$ \textbf{Hz}] [Q$_3$] [1,2,1,3])}\label{sec:15.5.8}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Void:The Court of $\DREH$ --- The Residue Courts $\anchor{}\textbf([852$ \textbf{Hz}] [Q$_1$] [1,3,2,0])}\label{sec:15.5.9}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Shadow: The Court of $\RHEA$ --- The Absorption Courts $\anchor{}\textbf([396$ \textbf{Hz}] [Q$_2$] [1,2,2,1])}\label{sec:15.5.10}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Resonance:The Court of $\ZHEK$ --- The Phase-Lock Courts $\anchor{}\textbf([963$ \textbf{Hz}] [Q$_3$] [1,1,2,2])}\label{sec:15.5.11}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Gates: The Court of $\SHAV$ --- The Resistance Courts $\anchor{}\textbf([285$ \textbf{Hz}] [Q$_1$] [1,3,1,1])}\label{sec:15.5.12}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\subsubsection*{ Silence: The Court of $\TRIG$ --- The Completion Courts $\anchor{}\textbf([639$ \textbf{Hz}] [Q$_3$] [1,1,3,2])}\label{sec:15.5.13}
\begin{scriptsize}
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{} l c l p{4.2cm} p{2.8cm} c l c @{}}
\toprule
...
\newpage
\section{SENSORIAL AND EMOTIONAL MATRICES}\label{sec:partXVIII}
...
\begin{description}
    ...
    \item[\AHN{} (Void):] \ahnroeh = $\anchor({i_{417}} \pm\phi) \equiv\parity (432)$\,\text{Hz} \\
...
\begin{description}
    ...
    \item[\AHN{} (Void):] \ahnsen = $\anchor({i_{417}} \pm\phi) \equiv\parity (432)$\,\text{Hz} \\
...
\begin{description}
    ...
    \item[\AHN{} (Void):] \ahnuth = $\anchor({i_{417}} \pm\phi) \equiv\parity (432)$\,\text{Hz} \\
...
\begin{description}
    ...
    \item[\AHN{} (Void):] \ahnfae = $\anchor({i_{417}} \pm\phi) \equiv\parity (432)$\,\text{Hz} \\
