...
\bibliographystyle{alpha} % Alpha style for neurodivergent readers [Jun69], [Ahn26]
\bibliography{ALQC_Canon_bibli} % The name of your .bib file without the extension
